...
void Quad::draw() const {
    ...
    // bottom left
    glVertex2i(bottomLeftX, bottomLeftY);
    // bottom right
    glVertex2i(bottomLeftX+width, bottomLeftY);
    // top right
    glVertex2i(bottomLeftX+width, bottomLeftY+height);
    // top left
    glVertex2i(bottomLeftX, bottomLeftY+height);
